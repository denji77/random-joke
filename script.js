const jokes = [
    ...
    "Why do fish always have a hard time telling jokes? Because they have a bad pun!",
    ...
    "Why don’t seagulls fly backwards? Because they’d be called backwards seagulls!",
    ...
    "Why don’t elephants play chess? Because their trunks are too big!",
    "Why did the cow jump over the moon? Because the farmer was trying to milk it!",
    "What do you call a cow that can’t sing? A silent cow!",
    "Why don’t chickens play basketball? Because they’d foul the other team!",
    "What do you call a chicken that knows karate? A chick-en!",
];
...
document.getElementById('button3').addEventListener('click',function(){
    let rand_no=prompt(`Enter the random number between 0-${jokes.length-1}`)

    alert(!isNaN(rand_no) && rand_no >= 0 && rand_no < jokes.length ? jokes[rand_no] : "Please enter a valid number between 0-" + (jokes.length - 1));
